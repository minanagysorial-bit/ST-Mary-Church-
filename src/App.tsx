...
const WhatsAppBroadcastPage = lazy(() => import('./pages/admin/WhatsAppBroadcastPage').then(m => ({ default: m.WhatsAppBroadcastPage })));
      ...
      <div className="flex-1">
        <Suspense fallback={<LoadingFallback />}>
          <Routes>
            ...
            <Route path="/admin/whatsapp" element={<ProtectedRoute allowedRoles={['super_admin', 'admin', 'priest', 'service_leader', 'servant']} requiredPermission={PERMISSIONS.CAN_SEND_WHATSAPP_BROADCAST}><WhatsAppBroadcastPage /></ProtectedRoute>} />
