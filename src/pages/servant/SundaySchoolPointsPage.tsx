  ...
  return (
    <DashboardLayout role={profile?.role as any || 'servant'}>
      <div className="space-y-6 text-right font-cairo" dir="rtl">
        ...
        {/* Page Top Title & Public Leaderboard / Store Buttons */}
        <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-4 bg-white p-5 rounded-3xl border border-slate-200 shadow-sm">
          <div>
          ...
          <div className="flex flex-wrap items-center gap-2">
            <Link
              to="/servant/expo"
              className="px-4 py-2.5 bg-gradient-to-r from-emerald-600 to-teal-600 text-white rounded-2xl font-black text-xs flex items-center gap-2 shadow-md hover:scale-105 transition-all active:scale-95"
            >
              <ShoppingBag className="w-4 h-4 text-white" />
              <span>إدارة المعرض والطلبات 🎁</span>
            </Link>
            <a
              href="/store"
              target="_blank"
              rel="noreferrer"
              className="px-4 py-2.5 bg-slate-100 hover:bg-slate-200 text-slate-800 rounded-2xl font-black text-xs flex items-center gap-2 border border-slate-200 shadow-sm transition-all active:scale-95"
            >
              <Gift className="w-4 h-4 text-amber-500" />
              <span>رابط متجر الأولاد 🛍️</span>
