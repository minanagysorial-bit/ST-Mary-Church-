  ...
  return (
    <div className="min-h-screen bg-[#fbf9f8] font-cairo">
      ...
      <div className="max-w-3xl mx-auto px-4 -mt-10 relative z-30">
        <div className="bg-white rounded-3xl p-6 sm:p-7 shadow-xl border border-[#d4af37]/30 grid grid-cols-1 sm:grid-cols-2 gap-6 text-center divide-y sm:divide-y-0 sm:divide-x sm:divide-x-reverse divide-slate-100 animate-tab-transition">
